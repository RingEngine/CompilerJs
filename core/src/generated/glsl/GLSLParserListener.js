...
export default class GLSLParserListener extends antlr4.tree.ParseTreeListener {

	// Enter a parse tree produced by GLSLParser#translation_unit.
	enterTranslation_unit(ctx) {
	}
